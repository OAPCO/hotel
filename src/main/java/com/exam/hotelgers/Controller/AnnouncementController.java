...
public class AnnouncementController {
    ...
    public String insertProc(@ModelAttribute AnnouncementDTO announcementDTO, RedirectAttributes redirectAttributes,
        ...
        if(announcementService.insert(announcementDTO,file)!=null) {
    ...
    public String updateProc(@ModelAttribute AnnouncementDTO announcementDTO,
                             @RequestParam("file") MultipartFile file, RedirectAttributes redirectAttributes) {
        log.info("서비스로 수정처리....");

        if(announcementService.update(announcementDTO, file) != null) {
